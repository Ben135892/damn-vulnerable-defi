...
describe("[Challenge] Selfie", function () {
    ...
    before(async function () {
        ...
        const DamnValuableTokenSnapshotFactory =
        ...
        this.governance = await SimpleGovernanceFactory.deploy(
            this.token.address
        );
    ...
    it("Exploit", async function () {
        ...
        /* METHOD: 
        Take out flash loan of more than 1 million DVT tokens?? or 1, in order to have enough
        votes to propose an action. This action will call the drainAllFunds method in 
        the pool when executed two day after the proposal.
        */
